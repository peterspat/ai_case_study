...
from taipy_keybert.src.functions import extract_arxiv, preprocess_data, run_keybert, get_keyword_value_counts, \
    save_in_dataframe

with open(r'C:\Data\ai_case_study\taipy_keybert//config.yml') as f:
